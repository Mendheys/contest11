...
let url = "https://api.github.com/search/repositories?q=stars:%3E1+language:javascript"
...
next.addEventListener("click",() => {
    ...
    page++;
    let link = `https://api.github.com/search/repositories?q=stars:%3E1+language:javascript&page=${page}`
    fetchData(link)
})
