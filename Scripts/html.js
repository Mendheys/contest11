...
let url = "https://api.github.com/search/repositories?q=stars:%3E1+language:html"
...
next.addEventListener("click",() => {
    ...
    page++;
    let link = `https://api.github.com/search/repositories?q=stars:%3E1+language:html&page=${page}`
    fetchData(link)
})
