...
let url = "https://api.github.com/search/repositories?q=stars:%3E1+language:css"
...
next.addEventListener("click",() => {
    ...
    page++;
    let link = `https://api.github.com/search/repositories?q=stars:%3E1+language:css&page=${page}`
    fetchData(link)
})
